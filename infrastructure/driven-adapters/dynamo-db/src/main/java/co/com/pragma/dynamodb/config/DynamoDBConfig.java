...
public class DynamoDBConfig {
  ...
  @Bean
  @Profile({DynamoDBKeys.PROFILE_LOCAL})
  public DynamoDbAsyncClient amazonDynamoDB(@Value("${aws.dynamodb.endpoint}") String endpoint, @Value("${aws.region}") String region, MetricPublisher publisher) {
  ...
  @Bean
  @Profile({DynamoDBKeys.PROFILE_DEV, DynamoDBKeys.PROFILE_CER, DynamoDBKeys.PROFILE_PDN})
